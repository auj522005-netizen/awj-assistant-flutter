...
const Map<AiTask, String> defaultTaskModels = {
  ...
  AiTask.longContext:       'bigmodel:glm-4-long',
};
...
final List<AIModel> allModels = [
  ...
  const AIModel(
    ...
    maxTokens: 131072,
    costPer1kTokens: 0.0,
    description: 'أسرع موديل GLM-4 — مجاني ومتوازن',
  ),
  const AIModel(
    id: 'bigmodel:glm-4-long',
    provider: AIProvider.bigmodel,
    modelId: 'glm-4-long',
    name: 'GLM-4 Long',
    nameAr: 'GLM-4 لونج',
    ...
    maxTokens: 1048576,
    costPer1kTokens: 0.0,
    description: 'للنصوص الطويلة — سياق ضخم 1 مليون توكن',
  ),
